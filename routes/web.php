...
// Route::get("/about/{id?}/{name}/{email}", function ($id, $name, $email) { //paramétereket kell /-el elválasztva megadni az url-ben
...
Route::get("/services", [ServiceController::class, "index"]); //?-jel jelzi hogy tetszőlegesen adhatunk paramétert
